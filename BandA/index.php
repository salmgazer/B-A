...
if (isset($_POST['signup_email']) && isset($_POST['signup_password']) &&
 isset($_POST['signup_firstname']) && isset($_POST['signup_lastname'])) {
  ...
  if($control->user_control->master_add_user($control->connect->dbc, $user_id,
   $user_firstname, $user_lastname, $user_email, $user_password, $user_photo)){
                              ...
                              <div class="panel-body">
                                  ...
                                  <form class="form-horizontal" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>"  enctype="multipart/form-data">
                                      ...
                                      <div class="">
                                       ...
                                       <!--signup first name-->
                                      <div class="">
                                           <input class="form-control" name="signup_firstname" id="signup_fullname" type="text" placeholder="Full name"
                                             style="max-width:375px; height: 35px"required >
                                      </div><br>

                                      <!--signup last name-->
                                      <div class="">
                                           <input class="form-control" name="signup_lastname" id="signup_fullname" type="text" placeholder="Full name"
                                             style="max-width:375px; height: 35px"required >
                                      </div><br>
